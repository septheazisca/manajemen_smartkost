...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold mb-0">Riwayat Notifikasi</h4>
            <p class="text-muted small mb-0">Pantau semua aktivitas pengiriman pesan WhatsApp</p>
        </div>
        <a href="/admin/notifikasi" class="btn btn-light border p-2 px-3">
                        ...
                        <?php foreach ($log as $i => $l): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    ?>
                                    <span class="badge <?= $badge ?> border-0 p-2 px-3 rounded-pill" style="font-size: 0.7rem; font-weight: 500;">
                                        <?= strtoupper($l['jenis']) ?>
                                    </span>
                                </td>
                                <td>
