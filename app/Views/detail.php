    ...
    <div class="container">
      <div class="row g-4">
        ...
        <div class="col-lg-2 col-md-6 col-6">
          ...
          <a href="<?= base_url() ?>#kamar" class="footer-link">Kamar</a>
          <a href="<?= base_url() ?>#fasilitas" class="footer-link">Fasilitas</a>
          <a href="<?= base_url() ?>#testimoni" class="footer-link">Testimoni</a>
        </div>
